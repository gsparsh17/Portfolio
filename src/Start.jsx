  ...
  return (
    ...
    transition={{
      ...
      duration: 2,
        ...
        <div className='flex-row justify-center items-center text-center mt-24'>
        {text.map((el, i) => (
        <motion.span className="text-cyan-200 text-[4vw]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{
            duration: 5,
        ...
        <br />
            <img className="w-[12vw] mx-auto mt-8" src={myGif} alt="" />
        </div>
    </motion.div>
  )
}
